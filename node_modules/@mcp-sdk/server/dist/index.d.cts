...
declare abstract class MCPError extends Error {
    constructor(message?: string);
}
type Extra = unknown;
type Extras = Record<string, Extra>;
declare class UnexpectedStateError extends MCPError {
    extras?: Extras;
...
declare const MCPSessionEventEmitterBase: {
    new (): StrictEventEmitter<EventEmitter, MCPSessionEvents>;
};
declare class MCPSessionEventEmitter extends MCPSessionEventEmitterBase {
}
...
declare class MCPSession<T extends MCPSessionAuth = MCPSessionAuth> extends MCPSessionEventEmitter {
    #private;
...
declare const MCPEventEmitterBase: {
    new (): StrictEventEmitter<EventEmitter, MCPEvents<MCPSessionAuth>>;
};
declare class MCPEventEmitter extends MCPEventEmitterBase {
}
type Authenticate<T> = (request: http.IncomingMessage) => Promise<T>;
declare class MCP<T extends Record<string, unknown> | undefined = undefined> extends MCPEventEmitter {
    #private;
    options: ServerOptions<T>;
    constructor(options: ServerOptions<T>);
    get sessions(): MCPSession<T>[];
    /**
