...
> **步骤 0（先于任何工作流）：方向澄清。** 如果用户只给了一个笼统方向——没说清写作
> 角度、侧重点、目标读者、篇幅或结论倾向——AI 客户端应先像 brainstorming 一样向用户
> 提问、讨论确认这些要点，而不是直接拿宽泛主题跑 `wechat_deep_research` 或开始写作。
> 方向已经足够具体（用户已给出角度/结论倾向）时可直接进入下面的工作流。
